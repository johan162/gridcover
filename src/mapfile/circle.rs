...
pub fn apply_circle_obstacle(grid: &mut Grid, center_x: f64, center_y: f64, radius: f64) {
    // Convert center to grid coordinates
    let grid_center_x = grid.world_coordinate_to_grid_x(center_x) as i32;
    let grid_center_y = grid.world_coordinate_to_grid_y(center_y) as i32;
...
fn is_cell_in_circle(
    ...
    let cell_corners = [
        grid.grid_to_world_coordinate(grid_x, grid_y), // Bottom-left
        grid.grid_to_world_coordinate(grid_x + 1, grid_y), // Bottom-right
        grid.grid_to_world_coordinate(grid_x + 1, grid_y + 1), // Top-right
        grid.grid_to_world_coordinate(grid_x, grid_y + 1), // Top-left
    ];
